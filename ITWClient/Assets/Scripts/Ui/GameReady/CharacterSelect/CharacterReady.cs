    ...
    public void Update()
    {
        ...
        switch(selectState)
        {
            case SelectState.PlayerSelect:
                if(plCnt >= 1)
                {
                    if(ControllerAxisHelper.Instance.IsAxisDown(1, AxisDown.UP))
                    {
                        selecters[0].MoveNext(false);
                    }
                    if(ControllerAxisHelper.Instance.IsAxisDown(1, AxisDown.DOWN))
                    {
                ...
                if(plCnt == 2)
                {
                    if(ControllerAxisHelper.Instance.IsAxisDown(2, AxisDown.UP))
                    {
                        selecters[1].MoveNext(false);
                    }
                    if(ControllerAxisHelper.Instance.IsAxisDown(2, AxisDown.DOWN))
                    {
